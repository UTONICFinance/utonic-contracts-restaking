...
describe("utonic manager tests", () => {
  ...
  it("strategy ton delegate", async () => {
    ...
    let fakeAdminUnbanRes = await utonicManagerContract.sendAdminSwitchOperatorStatus(
    ...
    let adminUnbanRes = await utonicManagerContract.sendAdminSwitchOperatorStatus(
