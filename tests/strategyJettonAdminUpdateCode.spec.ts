...
describe("ton stake tests", () => {
  ...
  it("not admin try to update code", async () => {
    ...
    let userUpdate1 = await strategyJettonContract.sendAdminUpdateCode(
    ...
    const testUpdate = TestUpdate.createForDeploy(strategyJettonContract.address)
  ...
  it("admin update code", async () => {
    ...
    let adminUpdate = await strategyJettonContract.sendAdminUpdateCode(
