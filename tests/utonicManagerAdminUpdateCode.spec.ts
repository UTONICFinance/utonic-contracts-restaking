...
describe("ton stake tests", () => {
  ...
  it("not admin try to update code", async () => {
    ...
    let userUpdate1 = await utonicManagerContract.sendAdminUpdateCode(
    ...
    const testUpdate = TestUpdate.createForDeploy(utonicManagerContract.address)
  ...
  it("admin update code", async () => {
    ...
    let adminUpdate = await utonicManagerContract.sendAdminUpdateCode(
