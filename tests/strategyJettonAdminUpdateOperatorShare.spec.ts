...
describe("ton stake tests", () => {
  ...
  it("admin update operator strategy share", async () => {
    ...
    let userAddOperatorShare1 = await strategyJettonContract.sendAdminUpdateOperatorShare(
        user1.getSender(), 1,
    ...
    let adminAddOperatorShare = await strategyJettonContract.sendAdminUpdateOperatorShare(
        admin.getSender(), 1,
        operatorStrategyShareAddress, 1000000000n, "0.5"
    )
    operatorStrategyShareData = await operatorStrategyShareContract.getOperatorStrategyShareData()
    ...
    let userDecOperatorShare1 = await strategyJettonContract.sendAdminUpdateOperatorShare(
        user1.getSender(), 1,
    ...
    let adminDecOperatorShare = await strategyJettonContract.sendAdminUpdateOperatorShare(
        admin.getSender(), 1,
        operatorStrategyShareAddress, -500000000n, "0.5"
    )
    operatorStrategyShareData = await operatorStrategyShareContract.getOperatorStrategyShareData()
